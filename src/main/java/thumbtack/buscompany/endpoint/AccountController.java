...
public class AccountController {
    ...
    @DeleteMapping
    public ResponseEntity<Void> delete(@CookieValue(name = "JAVASESSIONID", value = "session_id") @NotNull String session_id) {
        return accountService.delete(session_id);
    }

    @GetMapping
    public ResponseEntity<UserResponse> get(@CookieValue(name = "JAVASESSIONID", value = "session_id") @NotNull String session_id) {
